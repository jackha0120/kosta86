	...
	<section>
		...
		<form method="post" action="bbsupdate.jsp">
			...
			<table style="margin: auto; width: 400px">
				<tr>
					<td>subject</td>
					<td><input type="text" name="sub" value="<%=vo.getSub()%>" >
				</tr>
				<tr>
					<td>Writer</td>
				...
				<tr>
					<td>PWD</td>
					<td><input type="password" name="pwd" id="pwd" value="<%=vo.getPwd()%>"></td>
				</tr>

				<tr>
					<td>Content</td>
					<td><textarea rows="10" cols="52" name="cont"><%=vo.getCont() %></textarea>
				</tr>
				<tr>
					<td colspan="2" style="text-align: right;"><input
						type="submit" value="Write" style="width: 100px; height: 30px;">
						<input type="button" value="List"
						style="width: 100px; height: 30px;" onclick="location='bbslist.jsp'"></td>
				</tr>
			</table>
		</form>
		</p>
